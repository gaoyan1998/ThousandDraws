...
public class PicCrop {
    ...
    private static void setUri(String moutPath){
        outPath = moutPath;
    }
    private static Uri buildUri() {
        if (outPath == null){
            outPath = Environment.getExternalStorageDirectory() + File.separator + "crop";
        }
        File cacheFolder = new File(outPath);
        ...
        String name = String.format("imagecrop-%d.png", System.currentTimeMillis());
        uri = Uri
    ...
    public static void cropFromUri(Activity context,Uri uri,String outPath,int type){
        setUri(outPath);
        setType(type);
